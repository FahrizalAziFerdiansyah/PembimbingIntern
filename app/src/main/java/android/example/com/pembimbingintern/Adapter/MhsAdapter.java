...
public class MhsAdapter extends RecyclerView.Adapter<MhsAdapter.MyViewHolder> {
    ...
    public MhsAdapter(List<Pengajuan> pengajuanList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        final String urlGambarBerita = "http://192.168.43.22/apimagang/uploads/" + pengajuanList.get(position).getFoto_mahasiswa();
