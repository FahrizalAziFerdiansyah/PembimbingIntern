...
public class PieprodiActivity extends AppCompatActivity {
    PieChart mPieChart;
    //    PieData pieData;
//    PieDataSet pieDataSet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pieprodi);
        mPieChart= findViewById(R.id.pieChart);
        mApiInterface= ApiClient.getClient().create(ApiInterface.class);
        getEntries();
    }
    private void getEntries() {
        Call<List<Chart>> listCall=mApiInterface.getJurusan();
            ...
            public void onResponse(Call<List<Chart>> call, Response<List<Chart>> response) {
                ...
                if (response.body() != null) {
                    for (Chart chart : response.body()) {
                        pieChart.add(new PieEntry(chart.getJumlah(), chart.getJurusan()));
                    }
